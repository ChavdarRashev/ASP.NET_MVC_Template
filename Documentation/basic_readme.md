...
- Темплейта е построен по приците на MVC обра\азеца (patern) с ASP.NET Core 5 технологията и EntityFramework Core 5
...
- За изтриване прио soft deleted не се override или  SaveChanges Remove методите на EntityFramework. За реализирането на Soft Delete се дефинира нов метод RemoveSoftAsync в DBContext-a